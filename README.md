...
[![Travis Status for stntngo/parquet-go](https://travis-ci.org/xitongsys/parquet-go.svg?branch=master&label=linux+build)](https://travis-ci.org/xitongsys/parquet-go)
[![godoc for stntngo/parquet-go](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/xitongsys/parquet-go)
...
```sh
go get github.com/stntngo/parquet-go
```
...
```sh
cd $GOPATH/src/github.com/stntngo/parquet-go/example
...
* Some type convert functions: [converter.go](https://github.com/stntngo/parquet-go/blob/master/types/converter.go)
...
Using this interface, parquet-go can read/write parquet file on different platforms. All the file sources are at [parquet-go-source](https://github.com/stntngo/parquet-go-source). Now it supports(local/hdfs/s3/gcs/memory).
...
[Example of ParquetWriter](https://github.com/stntngo/parquet-go/blob/master/example/local_flat.go)

* JSONWriter is used to write JSON strings
[Example of JSONWriter](https://github.com/stntngo/parquet-go/blob/master/example/json_write.go)

* CSVWriter is used to write data format similar with CSV(not nested)
[Example of CSVWriter](https://github.com/stntngo/parquet-go/blob/master/example/csv_write.go)
...
[Example of ParquetReader](https://github.com/stntngo/parquet-go/blob/master/example/local_nested.go)
...
[Example of ColumnReader](https://github.com/stntngo/parquet-go/blob/master/example/column_read.go)
...
[Example of tags](https://github.com/stntngo/parquet-go/blob/master/example/local_flat.go)
...
`
```
[Example of JSON schema](https://github.com/stntngo/parquet-go/blob/master/example/json_schema.go)
...
[Example of CSV metadata](https://github.com/stntngo/parquet-go/blob/master/example/csv_write.go)
...
2. `PARGO_PREFIX_` is a reserved string, which you'd better not use it as a name prefix. ([#294](https://github.com/stntngo/parquet-go/issues/294))
...
|-|-|
|[local_flat.go](https://github.com/stntngo/parquet-go/blob/master/example/local_flat.go)|write/read parquet file with no nested struct|
|[local_nested.go](https://github.com/stntngo/parquet-go/blob/master/example/local_nested.go)|write/read parquet file with nested struct|
|[read_partial.go](https://github.com/stntngo/parquet-go/blob/master/example/read_partial.go)|read partial fields from a parquet file|
|[read_partial2.go](https://github.com/stntngo/parquet-go/blob/master/example/read_partial2.go)|read sub-struct from a parquet file|
|[read_without_schema_predefined.go](https://github.com/stntngo/parquet-go/blob/master/example/read_without_schema_predefined.go)|read a parquet file and no struct/schema predefined needed|
|[read_partial_without_schema_predefined.go](https://github.com/stntngo/parquet-go/blob/master/example/read_partial_without_schema_predefined.go)|read sub-struct from a parquet file and no struct/schema predefined needed|
|[json_schema.go](https://github.com/stntngo/parquet-go/blob/master/example/json_schema.go)|define schema using json string|
|[json_write.go](https://github.com/stntngo/parquet-go/blob/master/example/json_write.go)|convert json to parquet|
|[convert_to_json.go](https://github.com/stntngo/parquet-go/blob/master/example/convert_to_json.go)|convert parquet to json|
|[csv_write.go](https://github.com/stntngo/parquet-go/blob/master/example/csv_write.go)|special csv writer|
|[column_read.go](https://github.com/stntngo/parquet-go/blob/master/example/column_read.go)|read raw column data and return value,repetitionLevel,definitionLevel|
|[type.go](https://github.com/stntngo/parquet-go/blob/master/example/type.go)|example for schema of types|
|[type_alias.go](https://github.com/stntngo/parquet-go/blob/master/example/type_alias.go)|example for type alias|
|[writer.go](https://github.com/stntngo/parquet-go/blob/master/example/writer.go)|create ParquetWriter from io.Writer|
|[keyvalue_metadata.go](https://github.com/stntngo/parquet-go/blob/master/example/keyvalue_metadata.go)|write keyvalue metadata|



## Tool

* [parquet-tools](https://github.com/stntngo/parquet-go/blob/master/tool/parquet-tools): Command line tools that aid in the inspection of Parquet files
